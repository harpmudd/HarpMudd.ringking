#
# user core constraints — The Legend of Kage Pocket core
#
# All clock domains are asynchronous to each other.
# ic = core_top instance in apf_top; mp1 = PLL instance in core_top.
#
# lkage PLL general[0..4] = clk_sys(48) / clk_vid(6) / clk_vid_90(6@90) /
# spare(48) / spare(48). Both CPUs (T80) and the YM run as clock-ENABLES in
# clk_sys, so there is no slow-CPU domain to except — everything is single-cycle
# at 48 MHz. All PLL outputs are mutually async to each other and to the bridge.
#
